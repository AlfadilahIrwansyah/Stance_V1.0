...
class RoleController extends Controller
{
    ...
    public function update(Request $request, $refRoleId)
    {
        ...
        return redirect()->route('rolePaging')->with('success', 'Role berhasil di update!');
    }

    public function delete($refRoleid)
    {
        $refRole = RefRole::findOrFail($refRoleid);
        $refRole->delete();
        return redirect()->route('rolePaging')->with('success', 'Role berhasil dihapus!');
    }
}
