...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ isset($item) ? route('UpdateItem', $item->id) : route('NewItem') }}" method="POST">
            @csrf
            @if (isset($item))
                @method('PUT')
            @endif
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" step="0.01" name="item_buy_price" id="item_buy_price"
                            ...
                            value="{{ old('item_buy_price', isset($item) ? $item->item_buy_price : '0.00') }}" required
                            autocomplete="item_buy_price">
                        <span id="item_buy_priceError" class="invalid-feedback" role="alert"></span>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" step="0.01" name="item_sell_price" id="item_sell_price"
                            class="form-control @error('item_sell_price') is-invalid @enderror"
                            value="{{ old('item_sell_price', isset($item) ? $item->item_sell_price : '0.00') }}"
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="item_stock" id="item_stock"
                        ...
                        value="{{ old('item_stock', isset($item) ? $item->item_stock : '') }}" required
                    ...
                    <select name="item_category" id="item_category" class="form-control">
                        ...
                        @foreach ($refCategory as $category)
                            <option value="{{ $category->REF_CATEGORY_ID }}"
                                {{ old('item_category', isset($item) ? $item->item_category : '') == $category->REF_CATEGORY_ID ? 'selected' : '' }}>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="checkbox" name="item_active" id="item_active"
                        ...
                        {{ old('item_active', isset($item) && $item->item_active ? 'checked' : '') }}
                        autocomplete="item_active" @disabled(true)>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
