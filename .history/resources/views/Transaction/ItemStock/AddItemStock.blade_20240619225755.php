            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="item_code" id="item_code"
                        ...
                        autocomplete="item_code" @if (isset($item) && $item->SELL_PRICE_AMT != 0.0) enabled @else disabled @endif>
                    <span id="item_codeError" class="invalid-feedback" role="alert"></span>
                </div>
                <div class="col-md-4">
                    <label for="item_buy_price" class="text text-dark col-form-label">
                ...
                <div class="col-md-4">
                    <label for="buy_date" class="text text-dark col-form-label">
                        {{ __('TANGGAL PEMBELIAN') }} <span class="text-danger">*</span>
                    </label>
                    <input type="date" class="form-control @error('buy_date') is-invalid @enderror" id="buy_date"
                        name="buy_date" autocomplete="buy_date"
                        value="{{ old('buy_date', isset($item) ? $item->BUY_DATE : $date) }}">
                    <span id="buy_dateError" class="invalid-feedback" role="alert"></span>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-4">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <textarea name="item_desc" id="item_desc" class="form-control @error('item_desc') is-invalid @enderror" required
                        autocomplete="item_desc">{{ old('item_desc', isset($item) ? $item->DESC : '') }}</textarea>
                    <span id="item_descError" class="invalid-feedback" role="alert"></span>
                </div>
                <div class="col-md-4">
                    <label for="item_active" class="text text-dark col-form-label">
                    ...
                    <input type="checkbox" name="item_active" id="item_active"
                        ...
                        autocomplete="item_active" @if (isset($item) && $item->SELL_PRICE_AMT != 0.0) enabled @else disabled @endif>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
