...
@section('content')
    <div class="container">
        ...
        <form action="POST" href="">
            ...
            <div class="row">
                <div class="col-md-4">
                    <button class="btn btn-primary text-light text-decoration-none fw-bolder" style="width: 100px"
                        onclick="window.history.go(-1); return false;">
                        {{ __('Cancel') }}
                    </button>
                </div>
                <div class="col-md-4">
                    <button type="submit" class="btn btn-primary text-light text-decoration-none fw-bolder"
                        style="width: 100px">
                        {{ __('Add Item') }}
                    </button>
                </div>
