...
@section('content')
    ...
    <script>
        const inputField = document.getElementById('item_sell_price');
        const checkbox = document.getElementById('item_active');

        inputField.addEventListener('input', function() {
            // Check if input field has value
            if (inputField.value.trim() !== '') {
                // If input field has value, enable checkbox
                checkbox.disabled = false;
            } else {
                // If input field is empty, disable checkbox
