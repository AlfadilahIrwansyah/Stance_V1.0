                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" step="0.01" name="item_buy_price" id="item_buy_price"
                            ...
                            value="{{ old('item_buy_price', '0.00') }}" required autocomplete="item_buy_price" autofocus>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" step="0.01" name="item_sell_price" id="item_sell_price"
                            class="form-control @error('item_code') is-invalid @enderror"
                            value="{{ old('item_sell_price', '0.00') }}" required autocomplete="item_sell_price" autofocus>
