...
@section('content')
    <div class="container">
        ...
        <form action="POST" href="">
            <div class="row mb-3">
                <div class="col-md-4">
                    <label for="item_code" class="text col-form-label">
                ...
                <div class="col-md-4">
                    <label for="item_buy_price" class="text col-form-label">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <label for="item_name" class="text col-form-label">
                ...
                <div class="col-md-4">
                    <label for="item_sell_price" class="text col-form-label">
                        {{ __('HARGA JUAL') }}
                    </label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" step="0.01" name="item_sell_price" id="item_sell_price"
                            class="form-control @error('item_code') is-invalid @enderror"
                            value="{{ old('item_sell_price', '0.00') }}" required autocomplete="item_sell_price">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <label for="item_stock" class="text col-form-label">
                ...
                <div class="col-md-4">
                    <label for="item_category" class="text col-form-label">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <label for="item_desc" class="text col-form-label">
                ...
                <div class="col-md-4">
                    <label for="item_active" class="text col-form-label">
                    ...
                    <input type="checkbox" name="item_active" id="item_active"
                        ...
                        value="{{ old('item_active') }}" required autocomplete="item_active" disabled>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
