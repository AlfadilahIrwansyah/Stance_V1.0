        ...
        <form action="POST" href="">
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <textarea type="text" name="item_desc" id="item_code"
                        class="form-control @error('item_desc') is-invalid @enderror" name="item_desc"
                        value="{{ old('item_desc') }}" required autocomplete="item_desc" autofocus>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-4">
