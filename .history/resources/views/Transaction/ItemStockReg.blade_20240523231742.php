    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div>
                ...
                <a href="{{route('AddItem')}}{{ route('role.detail', $rd['role']->REF_ROLE_ID) }}" class="btn btn-primary mb-2">
            ...
            <tbody>
                @foreach ($RefItem as $item)
                    <tr scope="row">
                        ...
                        <td id="sell_price">{{ format_currency($item->SELL_PRICE_AMT) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
