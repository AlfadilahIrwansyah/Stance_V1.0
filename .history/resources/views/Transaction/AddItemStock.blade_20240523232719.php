                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" step="0.01" name="item_sell_price" id="item_sell_price"
                            class="form-control @error('item_code') is-invalid @enderror"
                            value="{{ format_currency(old('item_sell_price')) }}" required autocomplete="item_sell_price" autofocus>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
    ...
    <script>
        $(document).ready(function() {
            $('#item_sell_price').on('input', function() {
                ...
                var FormattedSellPrice;
                if (sellPrice !== '') {
                    FormattedSellPrice = format_currency(sellPrice);
