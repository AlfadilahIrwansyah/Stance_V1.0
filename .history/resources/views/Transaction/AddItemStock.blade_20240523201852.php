            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    <label for="item_active" class="col-form-label">
                        {{ __('SIAP DIJUAL') }} <span class="text-danger">*</span>
                    </label>
                    <checkbox name="item_active" id="item_active"
                        class="form-control @error('item_active') is-invalid @enderror" value="{{ old('item_active') }}"
