...
@section('content')
    <div class="container">
        ...
        <form action="POST" href="">
            ...
            <div class="row">
                <div class="col-md-4">
                    <button class="btn btn-primary text-light text-decoration-none fw-bolder" onclick="window.history.go(-1); return false;">
                        <a class="text-light text-decoration-none fw-bolder">{{ __('Cancel') }}</a>
                    </button>
                </div>
                <div class="col-md-4">
