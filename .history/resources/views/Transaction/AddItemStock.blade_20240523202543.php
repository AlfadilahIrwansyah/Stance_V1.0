            ...
            <div class="row mb-3">
                ...
                {{-- <div class="col-md-4">
                    ...
                    <input type="checkbox" name="item_active" id="item_active"
                        class="form-check-input @error('item_active') is-invalid @enderror" value="{{ old('item_active') }}"
                        required autocomplete="item_active" autofocus>
                </div> --}}
                <div class="col-md-4">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="item_buy_price" id="item_sell_price"
                            class="form-control @error('item_code') is-invalid @enderror"
                            value="{{ old('item_buy_price') }}" required autocomplete="item_sell_price" autofocus>
                    </div>
                </div>
            </div>
            <div class="row mb-3">
