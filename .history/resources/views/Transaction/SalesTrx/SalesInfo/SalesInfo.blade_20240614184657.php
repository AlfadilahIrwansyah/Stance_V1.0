...
@section('content')
    <div class="container">
        ...
        <div id="infoview" class="" style="margin-top: 60px;">
            <form action="{{ route('SalesInfoFilter') }}" method="POST">
                <div class="my-1">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex">
                                <input type="month" class="form-control me-2" id="period-start"
                                    placeholder="{{ $datetime }}" value="{{ old('period-start', $datetime) }}" onchange="this.form.submit()">
                                <input type="month" class="form-control" id="period-end"
                                    value="{{ old('period-end', $datetime) }}" onchange="this.form.submit()">
                            </div>
                        </div>
