...
@section('content')
            ...
            <div class="my-1">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="d-flex">
                            <input type="date" class="form-control me-2" id="period-start"
                                placeholder="{{ $datetime }}" value="{{ old('period-end', $datetime) }}" onchange="">
                            <input type="date" class="form-control" id="period-end"
                                value="{{ old('period-start', $datetime) }}" onchange="updatePeriod()">
                        </div>
                    </div>
    ...
    @vite(['resources/css/sales.css', 'resources/js/sales.js'])
@endsection
