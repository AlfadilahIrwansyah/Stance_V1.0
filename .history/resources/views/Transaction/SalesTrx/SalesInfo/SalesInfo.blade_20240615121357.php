                ...
                <div class="my-1">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex">
                                <input type="month" class="form-control me-2" id="periodStart" name=""
                                    value="{{ old('periodStart', $periodStart) }}" onchange="this.form.submit()">
                                <input type="month" class="form-control" id="periodEnd"
                                    value="{{ old('periodEnd', $periodEnd) }}" onchange="this.form.submit()">
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="text text-dark fw-bolder">Total Item Terjual:
                                        <span>{{ $dataView['Summary']['TotalSoldItem'] }}</span></p>
                                    <p class="text text-dark fw-bolder">Total Transaksi:
                                        <span>{{ $dataView['Summary']['TotalTrx'] }}</span></p>
                                </div>
                                <div class="col-md-6">
                                    <p class="text text-dark fw-bolder">Total Pemasukan:
                                        <span>{{ format_currency($dataView['Summary']['Income'], true) }}</span></p>
                                    <p class="text text-dark fw-bolder">Total Keuntungan:
                                        <span>{{ format_currency($dataView['Summary']['Outcome'], true) }}</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
