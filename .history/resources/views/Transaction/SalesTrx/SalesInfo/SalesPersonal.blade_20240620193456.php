                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="d-flex text-center">
                            <div class="form-control me-2" id="periodStart">
                            ...
                            <div class="form-control me-2" id="periodEnd">
                                <label for="periodEnd">Bulan Akhir</label>
                        ...
                        <div class="chart bg-chart-light rounded shadow text-primary" id="chart" style="margin-top : 10">
                            {!! $userChart->container() !!}
                        </div>
                    </div>
                    <div class="col-md-6">
