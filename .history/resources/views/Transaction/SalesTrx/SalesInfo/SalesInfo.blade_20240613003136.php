...
@section('content')
    <div class="container">
        ...
        <h3 class="text text-dark fw-bolder">Berikut hasil penjualan kamu sesuai dengan periode yang dipilih</p>
        <div class="my-1">
            <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="bg-primary text-white p-2 rounded">Bulanan</h2>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <h2 class="bg-primary text-white p-2 rounded">Kategori</h2>
                <table class="table table-striped">
                    <thead class="bg-warning text-white">
                        <tr>
                            <th>Kategori</th>
