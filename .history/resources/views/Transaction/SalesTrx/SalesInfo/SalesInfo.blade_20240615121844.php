                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex">
                                <input type="month" class="form-control me-2" id="periodStart" name="periodStart"
                                    value="{{ old('periodStart', isset($periodStart) ? $periodStart :$datetime) }}" onchange="this.form.submit()">
                                <input type="month" class="form-control" id="periodEnd" name="periodEnd"
                                    value="{{ old('periodEnd', isset($periodEnd, $datetime) }}" onchange="this.form.submit()">
                            </div>
                        </div>
