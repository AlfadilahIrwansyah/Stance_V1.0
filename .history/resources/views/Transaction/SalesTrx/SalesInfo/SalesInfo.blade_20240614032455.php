                    ...
                    <div class="custom-summary col-md-6">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="text text-dark fw-bolder">Total Transaksi: <span>{{$dataView['Summary']['TotalSoldItem']}}</span></p>
                            </div>
                            <div class="col-md-6">
                                <p class="text text-dark fw-bolder">Total Pemasukan: <span>{{format_currency($dataView['Summary']['TotalSoldItem'], true)}}</span></p>
                                <p class="text text-dark fw-bolder">Total Keuntungan: <span>{{format_currency($dataView['Summary']['TotalSoldItem'], true)}}</span></p>
                            </div>
                        </div>
                    </div>
                </div>
