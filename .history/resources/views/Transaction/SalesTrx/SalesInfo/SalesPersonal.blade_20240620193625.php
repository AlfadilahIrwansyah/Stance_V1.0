                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="d-flex text-center">
                            <div class="form-control me-2 bg-dark" id="periodStart">
                                <label for="periodStart"
                                    class="text-light>Bulan Awal</label>
                                <input type="month"
                                    class="form-control" id="periodStart" name="periodStart"
                                    value="{{ isset($periodStart) ? $periodStart : $datetime }}"
                                    onchange="this.form.submit()">
                            </div>
                            <div class="form-control me-2 bg-dark" id="periodEnd">
