        ...
        <div class="my-1">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="d-flex">
                        <input type="date" class="form-control me-2" id="period-start" placeholder="dd/mm/yyyy" value="">
                        <input type="date" class="form-control" id="period-end" placeholder="dd/mm/yyyy">
                    </div>
                </div>
                <div class="col-m">
                    <div class="row">
