    ...
    <div class="container">
        ...
        <div id="infoview" class="" style="margin-top: 60px;">
            <form action="{{ route('SalesInfoFiltered') }}" method="GET">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="bg-chart rounded shadow text-primary" id="chart">
                            {!! $salesChart->container() !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <h2 class="chart bg-primary text-white p-2 rounded text-center">Bulanan</h2>
                            ...
                            <tbody>
                                @foreach ($dataView['Details'] as $items)
                                    <tr>
                                        ...
                                        <td>{{ format_currency($items->KEUNTUNGAN, true) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <div class="chart bg-chart rounded shadow text-primary" id="chart">
                            ...
                            <tbody>
                                @foreach ($categoryView as $items)
                                    <tr>
                                        ...
                                        <td>{{ $items->TOTAL_ITEM_TERJUAL }}</td>
