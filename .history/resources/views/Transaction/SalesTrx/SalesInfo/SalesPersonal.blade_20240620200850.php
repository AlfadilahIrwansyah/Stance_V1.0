...
@section('content')
    <div class="container">
        ...
        <div id="infoView" style="margin-top: 35px;">
            <form action="{{ route('SalesPersonalFilter') }}" method="GET">
                ...
                <div class="d-flex align-items-center mb-3">
                    <label for="periodStart" class="text-dark me-2">Bulan Awal</label>
                    <input type="month" class="form-control me-3" id="periodStart" name="periodStart"
                        value="{{ isset($periodStart) ? $periodStart : $datetime }}" onchange="this.form.submit()"
                        style="max-width: 200px;">

                    <label for="periodEnd" class="text-dark me-2">Bulan Akhir</label>
