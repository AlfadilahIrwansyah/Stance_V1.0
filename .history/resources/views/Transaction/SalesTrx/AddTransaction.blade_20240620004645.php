                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#form1">Form 1</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#form2">Form 2</a>
                            </li>
                        </ul>
            ...
            <div class="modal-dialog modal-s">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="selectCustModalBody">
                        @include('<LookUp class="Custom"></LookUp>erLookup', ['refCust' => $refCust])
                    </div>
                </div>
            </div>
        </div>
