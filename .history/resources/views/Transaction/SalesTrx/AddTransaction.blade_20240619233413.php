                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <input type="hidden" name="ref_cust_id" id="ref_cust_id" value="">
                        ...
                        <form id="addItemForm">
                                ...
                                <select class="form-control" id="itemCode" style="width: 100%;" required
                                    ...
                                    @foreach ($refItem as $item)
                                        <option value="{{ $item->ITEM_CODE }}" data-name="{{ $item->ITEM_NAME }}"
                                            ...
                                            data-ref_item_id="{{ $item->REF_ITEM_ID }}"
                                            data-stock="{{ $item->STOCK }}">{{ $item->ITEM_NAME }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('itemQty') is-invalid @enderror"
                                    id="itemQty" required min="0" step="1" min="1"
                                    max="100">
                            </div>
                            <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="selectCustModalBody">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-bs-toggle="tab" href="#form1">Form 1</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#form2">Form 2</a>
                            </li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div id="form2" class="container tab-pane fade"><br>
                                <form method="POST" action="{{ route('custAdd') }}">
                                    ...
                                    <div class="row mb-3">
                                        <label for="name"
                                            class="text text-dark col-md-4 col-form-label text-md-end">{{ __('Nama') }}</label>
                                        <div class="col-md-6">
                                            <input id="name" type="text"
                                                class="form-control @error('name') is-invalid @enderror" name="name"
                                                value="{{ old('name', isset($CustData) ? $CustData->CUST_NAME : '') }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <input id="emailCust" type="emailCust"
                                                class="form-control @error('emailCust') is-invalid @enderror"
                                                name="emailCust"
                                                value="{{ old('emailCust', isset($CustData) ? $CustData->CUST_emailCust : '') }}"
                                                required autocomplete="emailCust">
