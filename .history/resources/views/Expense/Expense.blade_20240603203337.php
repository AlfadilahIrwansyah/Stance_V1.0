...
@section('content')
    <div class="container px-2 mx-auto">
        <form action="{{ route('filtered.expense') }}" method="GET">
            <h1 class="text fw-bolder text-primary">Finance Reports</h1>
            <div class="row d-flex">
                ...
                <div class="col-md-6 h-100">
                    <div class="p-3 m-5 rounded shadow bg-light">
                        <h4>Sales Data</h4>
                            ...
                            <tbody>
                                @foreach ($salesData as $data)
                                    <tr>
                                        ...
                                        {{-- <td>{{ $data->SALES_TRX_H->TOTAL_TRX_AMT }}</td> --}}
                                        <td>{{ date('l d F Y', strtotime($data->TRX_DATE)) }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
