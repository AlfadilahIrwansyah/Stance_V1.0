    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center align-items-center p-4">
            <a href="{{ route('expenses.index') }}"
                class="btn btn- btn-block btn-custom d-flex flex-column align-items-center justify-content-center rounded-3 text-decoration-none">
                <i class="bi bi-bar-chart icon-medium"></i>
                <span>FINANCE</span>
            </a>
            <a href=""
                class="btn btn-warning btn-block btn-custom d-flex flex-column align-items-center justify-content-center rounded-3 text-decoration-none">
                <i class="bi bi-receipt icon-medium"></i>
                <span>FINANCE</span>
            </a>
            <a href=""
                class="btn btn-warning btn-block btn-custom d-flex flex-column align-items-center justify-content-center rounded-3 text-decoration-none">
                <i class="bi bi-archive icon-medium"></i>
                <span>FINANCE</span>
            </a>
