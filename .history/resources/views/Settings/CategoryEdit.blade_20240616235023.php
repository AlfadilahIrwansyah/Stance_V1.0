        ...
        @endisset
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="category_name" id="category_name"
                    ...
                    value="{{ old('category_name', isset($refCategory->CATEGORY_NAME)) }}" required autocomplete="category_name">
            ...
            <button type="submit" class="btn btn-primary" style="margin-top: 10px">isset()Update Kategori</button>
        </form>
        @if ($errors->any())
