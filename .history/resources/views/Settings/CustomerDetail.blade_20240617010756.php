...
@section('content')
    <div class="container">
        <form method="POST" action="">
            ...
            <div class="row mb-3">
                <label for="password"
                    class="text text-dark col-md-4 col-form-label text-md-end">{{ __('Password Baru') }}</label>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <label for="password-confirm"
                    class="text text-dark col-md-4 col-form-label text-md-end">{{ __('Konfirmasi Password') }}</label>
                <div class="col-md-6">
