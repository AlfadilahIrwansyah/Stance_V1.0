...
@section('content')
    <div class="container">
        <form method="POST" action="{{ route('register') }}">
            @csrf
            <div class="row mb-3">
                <label for="name" class="text text-dark text text-dark col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <label for="ref_role_id" class="text text-dark col-md-4 col-form-label text-md-end">{{ __('Role') }}</label>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <label for="email" class="text text-dark col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <label for="password" class="text text-dark col-md-4 col-form-label text-md-end">{{ __('Password') }}</label>
                <div class="col-md-6">
