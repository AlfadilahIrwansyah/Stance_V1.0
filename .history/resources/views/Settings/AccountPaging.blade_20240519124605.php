    ...
    <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#name, #username, #email, #password, #phone_number, #ref_role_id').on('blur', function() {
                    validateField(this);
                });
            });
        </script>
