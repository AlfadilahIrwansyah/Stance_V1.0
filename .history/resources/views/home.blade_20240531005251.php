...
@section('content')
    <div class="container">
        ...
        <div class="p-3 m-2 bg-chart rounded shadow text-primary" id="chart">
            <div>
                {!! $homeChart->container() !!}
            </div>
        </div>
        <div class="d-flex justify-content-center align-items-center p-4">
            <a href="{{ route('expenses.index') }}"
                class="btn btn-block btn-custom-dark d-flex flex-column align-items-center justify-content-center rounded-3" id="hb1">
