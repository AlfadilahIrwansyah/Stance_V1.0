        ...
        <div class="sidebar collapsed" id="sidebar">
            ...
            <div class="nav-item">
                ...
                <div class="collapse" id="stokManajemenCollapse">
                    ...
                    <a class="dropdown-item" href="{{ route('kategoriBarang') }}">Kategori Barang</a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="collapse" id="laporanKeuanganCollapse">
                    <a class="dropdown-item" href="{{ route('keuntungan') }}">Keuntungan</a>
                    <a class="dropdown-item" href="{{ route('sales') }}">Sales</a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="collapse" id="referensiCollapse">
                    ...
                    <a class="dropdown-item" href="{{ route('pelanggan') }}">Pelanggan</a>
                </div>
            </div>
