    ...
    <div id="app">
        <div class="sidebar collapsed" id="sidebar">
            ...
            <div class="nav-link dropdown">
                <a href="#" class="dropdown-toggle" id="kategoriDropdown" role="button" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    <i class="bi bi-tag"></i><span>Kategori Barang</span>
                </a>
                <ul class="dropdown-menu" aria-labelledby="kategoriDropdown">
                    <li><a class="dropdown-item" href="{{ route('kategori1') }}">Kategori 1</a></li>
                    <li><a class="dropdown-item" href="{{ route('kategori2') }}">Kategori 2</a></li>
                    <li><a class="dropdown-item" href="{{ route('kategori3') }}">Kategori 3</a></li>
                </ul>
            </div>
