...
<body class=" @if (Route::currentRouteName() === 'login' || Route::currentRouteName() === 'register') body-login @else body-home @endif">
    <div id="app">
        <div class="sidebar bg-dark" id="sidebar">
            ...
            <a href="#" class="nav-link"><i class="bi fa-home"></i><span>Home</span></a>
            <a href="#" class="nav-link"><i class="fas fa-cogs"></i><span>Services</span></a>
            <a href="#" class="nav-link"><i class="fas fa-users"></i><span>Clients</span></a>
