...
<body class=" @if (Route::currentRouteName() === 'login' || Route::currentRouteName() === 'register') body-login @else body-home @endif">
    <div id="app">
        <div class="sidebar bg-dark" id="sidebar">
            <div class="sidebar-logo" style="background-color: #f6921e; margin-bottom: 50px">
                <img src="{{ Vite::asset('resources/images/stance_logo_small.png') }}" alt="Stance Logo">
            </div>
            <div class="sidebar-item" style="margin-top: 100px;">
                <button class="btn btn-dark toggle-btn" id="toggle-btn">☰</button>
                <a href="#" class="nav-link"><i class="fas fa-home"></i><span>Beranda</span></a>
                <a href="#" class="nav-link"><i class="fas fa-box"></i><span>Stok Manajemen</span></a>
                <a href="#" class="nav-link"><i class="fas fa-cogs"></i><span>Kategori Barang</span></a>
                <a href="#" class="nav-link"><i class="fas fa-exchange-alt"></i><span>Transaksi</span></a>
                <a href="#" class="nav-link"><i class="fas fa-chart-line"></i><span>Laporan Keuangan</span></a>
                <a href="#" class="nav-link"><i class="fas fa-book"></i><span>Referensi</span></a>
