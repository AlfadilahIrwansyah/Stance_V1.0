    ...
    <div id="app">
        <div class="sidebar collapsed" id="sidebar">
            ...
            <a href="{{ route('logout') }}"
                ...
                document.getElementById('logout-form').submit(); return confirm('Apakah Kamu yakin akan menghapus pelanggan ini?');"
                class="nav-link">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                @else
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a id="navbarDropdown" class="text nav-link text-light" href="" role="button">
