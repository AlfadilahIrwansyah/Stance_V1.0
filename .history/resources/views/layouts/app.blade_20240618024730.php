        ...
        <div class="sidebar collapsed" id="sidebar">
            ...
            <div class="nav-item">
                ...
                <div class="collapse" id="laporanKeuanganCollapse">
                    <a class="dropdown-item" href="{{ route('TransactionPaging') }}SalesInfo"> <i class="bi bi-graph-up"></i>Keuntungan Penjualan</a>
                    <a class="dropdown-item" href=""> <i class="bi bi-graph-up"></i>Sales Perorang</a>
                </div>
            </div>
