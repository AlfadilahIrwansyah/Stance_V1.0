...
<body class=" @if (Route::currentRouteName() === 'login' || Route::currentRouteName() === 'register') body-login @else body-home @endif">
    <div id="app">
        <div class="sidebar bg-dark" id="sidebar">
            <button class="btn btn-dark mt-2 ms-2" id="toggle-btn">☰</button>
            <a href="#" class="nav-link"><i class="bi bi-home"></i><span>Home</span></a>
            <a href="#" class="nav-link"><i class="bi bi-cogs"></i><span>Services</span></a>
            <a href="#" class="nav-link"><i class="bi bi-users"></i><span>Clients</span></a>
            <a href="#" class="nav-link"><i class="bi bi-envelope"></i><span>Contact</span></a>
        </div>
