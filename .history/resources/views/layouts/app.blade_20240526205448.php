...
<body class=" @if (Route::currentRouteName() === 'login' || Route::currentRouteName() === 'register') body-login @else body-home @endif">
    <div id="app">
        <div class="sidebar" id="sidebar">
            ...
            <a href="#" class="nav-link text-decoration-none text-reset"><i
                    class="bi bi-house"></i><span>Beranda</span></a>
            <a href="#" class="nav-link text-decoration-none text-reset"><i class="bi bi-box"></i><span>Stok
                    Manajemen</span></a>
            <a href="#" class="nav-link text-decoration-none text-reset"><i class="bi bi-tag"></i><span>Kategori
                    Barang</span></a>
            <a href="#" class="nav-link text-decoration-none text-reset"><i
                    class="bi bi-receipt"></i><span>Transaksi</span></a>
            <a href="#" class="nav-link text-decoration-none text-reset"><i
                    class="bi bi-graph-up"></i><span>Laporan Keuangan</span></a>
            <a href="#" class="nav-link text-decoration-none text-reset"><i
                    class="bi bi-book"></i><span>Referensi</span></a>
            <a href="#" class="nav-link text-decoration-none text-reset"><i
                    class="bi bi-box-arrow-left"></i><span>Keluar</span></a>
        </div>
