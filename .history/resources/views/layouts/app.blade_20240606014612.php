        ...
        <div class="sidebar collapsed" id="sidebar">
            ...
            <div class="nav-item">
                ...
                <div class="collapse" id="stokManajemenCollapse">
                    ...
                    <a class="dropdown-item" href="">Kategori Barang</a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="collapse" id="laporanKeuanganCollapse">
                    <a class="dropdown-item" href=""> <i class="bi bi-graph-up"></i>Keuntungan</a>
                    <a class="dropdown-item" href=""> <i class="bi bi-graph-up"></i>Sales</a>
                </div>
            </div>
            ...
            <div class="nav-item">
                ...
                <div class="collapse" id="referensiCollapse">
                    <a class="dropdown-item" href=""> <i class="bi bi-book"></i>Akun</a>
