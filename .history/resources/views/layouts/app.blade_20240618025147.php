        ...
        <div class="sidebar collapsed" id="sidebar">
            ...
            <div class="nav-item">
                ...
                <div class="collapse" id="referensiCollapse">
                    <a class="dropdown-item" href="{{ route('accsetting') }}"> <i class="bi bi-book"></i>Akun</a>
                    <a class="dropdown-item" href="{{ route('custPaging') }}"> <i class="bi bi-book"></i>Pelanggan</a>
                    <a class="dropdown-item" href="{{ route('accsetting') }}"><i class="bi bi-person"></i>{{ __('Account Setting') }}</a>
                </div>
            </div>
