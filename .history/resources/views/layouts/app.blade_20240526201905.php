...
<body class=" @if (Route::currentRouteName() === 'login' || Route::currentRouteName() === 'register') body-login @else body-home @endif">
    <div id="app">
        <div class="sidebar bg-dark" id="sidebar">
            ...
            <a href="#" class="nav-link"><i class="bi bi-cogs"></i><span>Kategori Barang</span></a>
            <a href="#" class="nav-link"><i class="bi bi-exchange-alt"></i><span>Transaksi</span></a>
            <a href="#" class="nav-link"><i class="bi bi-chart-line"></i><span>Laporan Keuangan</span></a>
            <a href="#" class="nav-link"><i class="bi bi-book"></i><span>Referensi</span></a>
            <a href="#" class="nav-link"><i class="bi bi-sign-out-alt"></i><span>Keluar</span></a>
        </div>
