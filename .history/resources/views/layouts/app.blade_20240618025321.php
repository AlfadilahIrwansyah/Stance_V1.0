        ...
        <div class="sidebar collapsed" id="sidebar">
            ...
            <div class="nav-item">
                ...
                <div class="collapse" id="referensiCollapse">
                    <a class="dropdown-item" href="{{ route('accsetting') }}"> <i class="bi bi-people-fill"></i></i>Akun</a>
                    <a class="dropdown-item" href="{{ route('custPaging') }}"> <i class="bi bi-person-badge-fill"></i></i>Pelanggan</a>
                    @if (Auth::user()->REF_ROLE->ROLE_ACCESS == 'ALL' || Auth::user()->REF_ROLE->ROLE_NAME == 'admin')
                        <a class="dropdown-item" href="{{ route('rolePaging') }}"><i
                                class="bi bi-universal-access"></i>
                            {{ __('Role Setting') }}
                        </a>
                    @endif
                </div>
