    ...
    <div id="app">
        <div class="sidebar collapsed" id="sidebar">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" id="stokManajemenDropdown" role="button"
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" id="laporanKeuanganDropdown" role="button"
                    data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" id="referensiDropdown" role="button"
                    data-bs-toggle="dropdown" aria-expanded="false">
