...
$(document).ready(function() {
    ...
    $(document).click(function(event) {
        if (!sidebar.is(event.target) && !sidebar.has(event.target).length && !toggleBtn.is(event.target) && mainContent.is(event.target)) {
    ...
    // Current path matches one of the routes
    console.log('Current path matches one of the routes.');
} else {
    // Current path doesn't match any of the routes
    console.log('Current path does not match any of the routes.');
}
});
