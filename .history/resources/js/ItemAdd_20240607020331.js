...
$(function() {
    ...
    $('#saveItemButton').on('click', function() {
            ...
            var newRow = `
                <tr>
                    <td>${itemCode} <input type="hidden" name="items[][code]" value="${itemCode}"></td>
                    <td>${itemName} <input type="hidden" name="items[][name]" value="${itemName}"></td>
                    <td>${itemQty} <input type="hidden" name="items[][qty]" value="${itemQty}"><input type="hidden" name="items[][ref_item_id]" value="${itemId}"></td>
                    <td>${formatCurrency(itemPrice, true)} <input type="hidden" name="items[][price]" value="${itemPrice}"></td>
                    <td>${formatCurrency(itemTotal, true)} <input type="hidden" name="items[][total]" value="${itemTotal}"></td>
                </tr>
            `;
        ...
        function calculateTotal() {
            ...
            $('#totalInput').text(formatCurrency(grandTotal, true));
        }
});
