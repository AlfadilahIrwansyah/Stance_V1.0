...
$(window).on('load', function() {
    ...
    var phpFileUrl = "{{ asset('app/Http/Controllers/HomeContoller.php') }}"; // Replace 'path/to/your/file.php' with the path to your PHP file

        $.ajax({
                url: 'app/Http/Controllers/HomeContoller.php',
                type: 'POST',
