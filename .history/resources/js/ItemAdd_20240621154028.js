...
$(function() {
    ...
    $('#itemQty').on('blur', function() {
            ...
            console.log(Number.isInteger(itemQty));
            if(!Number.isInteger(itemQty)){
                $('#itemQtyError').addClass('is-invalid');
                $('#itemQtyError').text('Input stok harus bilangan bulat');
            }
            else {
                $('#itemQtyError').removeClass('is-invalid');
                $('#itemQtyError').text('');
            }

            if(itemQty > itemstock) {
                $('#itemQty').addClass('is-invalid');
                $('#itemQty').text('Stok tidak mencukupi');
            } else {
