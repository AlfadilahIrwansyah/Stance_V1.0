...
$(function() {
    ...
    $('#darkMode').on('change', function() {
        ...
        let ChartClass = '#' + fieldName + 'Error';
        if (isChecked) {
            $('body').removeClass('body-home-light');
            $('body').addClass('body-home-dark');
            $('.navbar').removeClass('navbar-light');
            $('.navbar').addClass('navbar-dark');
            $(ChartClass).removeClass('bg-chart-light');
            $(ChartClass).addClass('bg-chart-dark');
            ...
            $(ChartClass).addClass('bg-chart-light');
            $(ChartClass).removeClass('bg-chart-dark');
