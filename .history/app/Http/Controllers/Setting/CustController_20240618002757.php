...
class CustController extends Controller
{
    ...
    {
        $refCust = Customer::paginate(10); // Adjust pagination size as needed
        if ($request->ajax()) {
            return view('partials.customer_pagination', compact('refCust'))->render();
        }
        return view('your_main_view', compact('refCust'));
    }
}
