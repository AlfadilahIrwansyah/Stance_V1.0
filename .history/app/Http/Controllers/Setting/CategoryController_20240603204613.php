...
class CategoryController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $refCategoryid)
    {
        $refCategory = RefCategory::findOrFail($refCategoryid);

        $request->validate([
            'CATEGORY_NAME' => 'string|unique:REF_CATEGORY',
        ]);
        $refCategory->update();

        return redirect()->route('CategoryP')->with('success', 'Role updated successfully!');
    }
}
