...
class CustController extends Controller
{
    ...
    public function deleteCust(Request $request, $refCustID)
    {
        dd($)
        $refCust = RefCust::findOrFail($refCustID);
        $refCust->delete();

        return redirect()->route('custPaging')->with('success', 'Berhasil Hapus Pelanggan');
    }
}
