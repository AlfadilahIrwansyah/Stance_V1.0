...
class SalesController extends Controller
{
    ...
    public function getOutcome($dateStart = null, $dateEnd = null)
    {
        if ($dateStart !== null && $dateEnd !== null) {
            $items = RefItem::filterDateItem($dateStart, $dateEnd)->get();
        } else {
            $items = RefItem::all();
        }
        $outcome = 0;
    ...
    {
        if ($dateStart !== null && $dateEnd !== null) {
            $items = SalesTrxH::filterDateSales($dateStart, $dateEnd)->get();
        } else {
            $items = SalesTrxH::all();
        }
        $Turnover = 0;
    ...
    {
        if ($dateStart !== null && $dateEnd !== null) {
            $salesTrxH = SalesTrxH::filterDateSales($dateStart, $dateEnd)->get();
        } else {
    ...
    public function showSales(Request $request)
    {
        ...
        dd($this->getTotalTransactionDetail($periodStart, $periodEnd));
