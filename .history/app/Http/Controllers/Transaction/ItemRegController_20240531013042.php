...
class ItemRegController extends Controller
{
    ...
    public function validateItem(Request $request)
    {
        ...
        // $rules = [
        //     'item_code' => ['required:Kode Barang Perlu di Isi dan Unik','string','max:255','unique:REF_ITEM'],
        ...
        $messages = [
            ...
            'item_buy_price.regex' => 'Harga Beli harus berupa angka dengan format contoh 50000.',
            'item_sell_price.regex' => 'Harga Jual harus berupa angka dengan format xx contoh 50000.',
