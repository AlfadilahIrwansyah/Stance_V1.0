...
class SalesController extends Controller
{
    ...
    public function showSalesFiltered(Request $request)
    {
        ...
        if ($periodEnd < $periodStart || $periodStart > $periodEnd) {
            return back()->with('errorEnd', 'Tanggal periode akhir lebih kecil dari periode awal');
        } elseif ($periodStart > $periodEnd) {
            return back()->with('errorStart', 'Tanggal periode awal lebih besar dari periode akhir');
        }
