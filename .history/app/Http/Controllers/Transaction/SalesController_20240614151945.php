...
class SalesController extends Controller
{
    ...
    {
        if ($dateStart !== null && $dateEnd !== null) {
            $salesTrxH = SalesTrxH::filterDateRange($dateStart, $dateEnd)->get();
        } else {
        ...
        $Income = ($this->getTurnover($dateStart, $dateEnd) - $Outcome);
        ...
        $subquery = DB::table('SALES_TRX_H as H')
            ...
            ->selectRaw('MONTH(H.TRX_DATE) as BULAN, H.TOTAL_TRX_AMT as TOTAL_OMSET, COUNT(1) as TRANSAKSI, SUM((D.ITEM_AMT * RI.SELL_PRICE_AMT) - (D.ITEM_AMT * RI.BUY_PRICE_AMT)) as KEUNTUNGAN')
            ->groupBy('H.TOTAL_TRX_AMT', 'H.TRX_DATE', 'D.ITEM_AMT', 'RI.SELL_PRICE_AMT');
