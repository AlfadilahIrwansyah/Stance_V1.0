...
class TransactionController extends Controller
{
    ...
    {
        $salesData = SalesTrxH::with('REF_USER')->get();
    ...
    {
        $salesTrxH = SalesTrxH::where('SALES_TRX_NO', $trxno)->first();
        $salesTrxD = SalesTrxD::where('SALES_TRX_H_ID', $salesTrxH->id)->all();
        return view('Transaction.SalesTrx.TransactionDetailView', compact('salesTrxH', 'TransData'));
    }
}
