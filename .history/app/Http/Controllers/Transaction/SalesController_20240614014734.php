...
class SalesController extends Controller
{
    ...
    public function scopeFilterByYearMonth($query, $yearMonth)
    {
        // Extract year and month from the input 'yyyy-mm'
        $year = substr($yearMonth, 0, 4);
        $month = substr($yearMonth, 5, 2);

        // Use where clause to compare year and month parts of the date
