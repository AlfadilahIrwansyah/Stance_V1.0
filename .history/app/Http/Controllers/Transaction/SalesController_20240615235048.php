...
class SalesController extends Controller
{
    ...
    private function getTotalTransactionDetail($dateStart = null, $dateEnd = null)
    {
        ...
        $totalDetails = $dataGrid);

        $Income = 0;

        foreach ($dataGrid as $Omzet) {
            $Income += $Omzet->TOTAL_OMSET;
        }
        $Surplus = $Income - $Outcome;
        $dataSales = [
            'TotalTrx' => $dataGrid->sum('TOTAL_TRANSAKSI'),
    ...
    public function showSales()
    {
        ...
        return view('Transaction.SalesTrx.SalesInfo.SalesInfo', compact('datetime', 'dataView', 'categoryView'));
    }
