...
class SalesController extends Controller
{
    ...
    {
        $datetime = Carbon::now()->format('Y-m');
        $userSales = SalesTrxH::selectRaw('REF_USER.name as user_name, SalesTrxH.total_trx_amt')
            ->join('REF_USER', 'SalesTrxH.REF_USER_ID', '=', 'REF_USER.ID') // Ensure you are joining on the correct columns
            ->get();
        dd($userSales);
