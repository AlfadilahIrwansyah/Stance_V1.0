...
class SalesController extends Controller
{
    ...
    {
        $datetime = Carbon::now()->format('Y-m');
        $userSalesQuery = SalesTrxH::selectRaw('REF_USER.name as user_name, SalesTrxH.total_trx_amt')
            ->join('REF_USER', 'SalesTrxH.REF_USER_ID', '=', 'REF_USER.REF_USER_ID');

        dd($userSalesQuery->toSql());
