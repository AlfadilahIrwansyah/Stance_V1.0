...
class SalesController extends Controller
{
    ...
    public function showSales(Request $request)
    {
        ...
        $periodStart = $request->input('period-start', $datetime);
        $periodEnd = $request->input('period-end', $datetime);
        // dd($periodEnd, $periodStart, $request->input('period-end'), $request->input('period-start'));
