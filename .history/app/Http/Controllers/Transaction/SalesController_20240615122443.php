...
class SalesController extends Controller
{
    ...
    public function showSalesFiltered(Request $request)
    {
        ...
        if ($periodEnd < $periodStart) {
            return url('/SalesInfo')->with('Error', 'Tanggal periode akhir lebih kecil dari periode awal');
        }elseif($periodStart > $periodEnd){
            return url('/SalesInfo')->with('Error', 'Tanggal periode awal lebih besar dari periode akhir');
        }
