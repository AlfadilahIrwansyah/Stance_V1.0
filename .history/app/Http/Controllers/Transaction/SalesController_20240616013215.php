...
class SalesController extends Controller
{
     ...
     */
    public function showSales(SalesChart $salesChart)
    {
        ...
        return view('Transaction.SalesTrx.SalesInfo.SalesInfo', compact('datetime', 'dataView', 'categoryView', 'salesChart'));
    }
     ...
     * @return \Illuminate\Contracts\Support\Renderable
     */
    public function showSalesFiltered(SalesChart $salesChart,Request $request)
    {
        $datetime = Carbon::now()->format('Y-m');
        ...
        return view('Transaction.SalesTrx.SalesInfo.SalesInfo', ['datetime', 'dataView' => $dataView, 'periodStart' => $periodStart, 'periodEnd' => $periodEnd, 'categoryView' => $categoryView]);
    }
