...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        //     ];
        // });
        $roles = RefRole::with('roleAccesses')->paginate(10); // Adjust the number as needed
        $RoleData = $roles->map(function ($role) {
            return [
                'role' => $role,
                'roleAccesses' => $role->roleAccesses->pluck('name')->toArray(), // Adjust this according to your access field
            ];
        });
        // dd($refAccess);
