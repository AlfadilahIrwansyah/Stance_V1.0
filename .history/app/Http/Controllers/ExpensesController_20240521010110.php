...
class ExpensesController extends Controller
{
    ...
    public function index(Barchart $Barchart, LinesChart $Linechart, HoriBarchart $horiBarchart, Request $request)
    {
        ...
        $salesData = SalesData::with('ref_item')
            ->join('ref_items', 'sales_data.ref_item_id', '=', 'ref_items.id') // Adjust this line based on your actual relationship
            ->select('sales_data.*', 'ref_items.item_name') // Select necessary columns
            ->getQuery();
