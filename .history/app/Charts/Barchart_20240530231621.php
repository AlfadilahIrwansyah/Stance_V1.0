...
class Barchart extends LarapexChart
{
    ...
    public function build(): \ArielMejiaDev\LarapexCharts\BarChart
    {
        ...
        foreach ($itemSalesData as $item => $data) {
            ...
            foreach ($months as $month) {
                ...
                $monthlySales[] = $monthData ? $monthData->TOTAL_TRX_AMT : 0;
            }
    ...
    {
        $salesMonth = SalesTrxH::select(DB::raw("DISTINCT DATENAME(MONTH, date_sale) as month_name, MONTH(date_sale) as month_number"))
