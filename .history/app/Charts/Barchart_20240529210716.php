    ...
    public function buildHomeLinechart(): \ArielMejiaDev\LarapexCharts\LineChart
    {
        ...
        foreach ($salesByYear as $year => $data) {
            ...
            foreach ($months as $month) {
                ...
                $monthlySales[] = $found ? format_currency($found->total_sales) : 0;
            }
        ...
        $chart->setDataLabelsEnabled(true); // Enable data labels if not already enabled
        $chart->setOptions([
            'dataLabels' => [
