...
Route::get('/customers/paginate', [CustController::class, 'paginateCust'])->name('CustPaginate');
Route::get('/search-customers', [YourController::class, 'searchCustomers'])->name('searchCustomers');
