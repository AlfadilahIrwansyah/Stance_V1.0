...
Route::get('/AccountPaging', [App\Http\Controllers\AccountController::class, 'ShowAccountPage'])->name('accsetting');
Route::get('/AccountSettings/{user}/editAcc', [App\Http\Controllers\AccountController::class, 'edit'])->name('accsetting.edit');
Route::Post('/AccountSettings/{user}/editAcc', [App\Http\Controllers\AccountController::class, 'edit'])->name('accsetting.edit');
