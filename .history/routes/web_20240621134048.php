...
Route::post('/AccountDelete', [AccountController::class, 'UserDelete'])->name('UserDelete');
...
Route::post('/AccountSettings/RoleEdit/{refRole}', [RoleController::class, 'delete'])->name('role.delete');
...
Route::post('/Category-validate', [CategoryController::class, 'validateCategory'])->name('CategoryV');
Route::post('/Category-new', [CategoryController::class, 'categoryNew'])->name('CategoryN');
Route::get('/Category-add', [CategoryController::class, 'categoryAdd'])->name('CategoryA');
...
Route::get('/CustPaging', [CustController::class, 'custPaging'])->name('custPaging');
Route::get('/CustDetail/{CustId}', [CustController::class, 'custDetail'])->name('custDetail');
Route::get('/CustNew', [CustController::class, 'custNew'])->name('custNew');
Route::post('/CustNew', [CustController::class, 'custAdd'])->name('custAdd');
Route::post('/CustDelete/{refCustID}', [CustController::class, 'deleteCust'])->name('custDelete');
Route::get('/search-customers', [CustController::class, 'searchCustomers'])->name('searchCustomers');
